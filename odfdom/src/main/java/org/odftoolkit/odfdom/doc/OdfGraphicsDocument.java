...
public class OdfGraphicsDocument extends OdfDocument {
  ...
  static final Resource EMPTY_GRAPHICS_DOCUMENT_RESOURCE =
   ...
   */
  @Override
  public OfficeDrawingElement getContentRoot() throws SAXException, IOException  {
